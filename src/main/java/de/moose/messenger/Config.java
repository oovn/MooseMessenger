...
public final class Config {
	...
	public static final String LOGTAG = "Moose Messenger";

	public static final Jid BUG_REPORTS = Jid.of("rey@moose-messenger.com");


	public static final String DOMAIN_LOCK = "moose-messenger.com"; //only allow account creation for this domain
	public static final String MAGIC_CREATE_DOMAIN = "moose-messenger.com";
