package de.moose.messenger.services;
...
import de.moose.messenger.PushManagementService;
import de.moose.messenger.Config;
import de.moose.messenger.R;
import de.moose.messenger.crypto.OmemoSetting;
import de.moose.messenger.crypto.axolotl.AxolotlService;
import de.moose.messenger.crypto.axolotl.FingerprintStatus;
import de.moose.messenger.crypto.axolotl.XmppAxolotlMessage;
import de.moose.messenger.entities.Account;
import de.moose.messenger.entities.Blockable;
import de.moose.messenger.entities.Bookmark;
import de.moose.messenger.entities.Contact;
import de.moose.messenger.entities.Conversation;
import de.moose.messenger.entities.Conversational;
import de.moose.messenger.entities.DownloadableFile;
import de.moose.messenger.entities.Message;
import de.moose.messenger.entities.MucOptions;
import de.moose.messenger.entities.MucOptions.OnRenameListener;
import de.moose.messenger.entities.Presence;
import de.moose.messenger.entities.PresenceTemplate;
import de.moose.messenger.entities.Roster;
import de.moose.messenger.entities.ServiceDiscoveryResult;
import de.moose.messenger.entities.Transferable;
import de.moose.messenger.entities.TransferablePlaceholder;
import de.moose.messenger.generator.AbstractGenerator;
import de.moose.messenger.generator.IqGenerator;
import de.moose.messenger.generator.MessageGenerator;
import de.moose.messenger.generator.PresenceGenerator;
import de.moose.messenger.http.HttpConnectionManager;
import de.moose.messenger.http.CustomURLStreamHandlerFactory;
import de.moose.messenger.parser.AbstractParser;
import de.moose.messenger.parser.IqParser;
import de.moose.messenger.parser.MessageParser;
import de.moose.messenger.parser.PresenceParser;
import de.moose.messenger.persistance.DatabaseBackend;
import de.moose.messenger.persistance.FileBackend;
import de.moose.messenger.ui.SettingsActivity;
import de.moose.messenger.ui.UiCallback;
import de.moose.messenger.ui.interfaces.OnAvatarPublication;
import de.moose.messenger.ui.interfaces.OnMediaLoaded;
import de.moose.messenger.ui.interfaces.OnSearchResultsAvailable;
import de.moose.messenger.utils.Compatibility;
import de.moose.messenger.utils.ConversationsFileObserver;
import de.moose.messenger.utils.CryptoHelper;
import de.moose.messenger.utils.ExceptionHelper;
import de.moose.messenger.utils.MimeUtils;
import de.moose.messenger.utils.OnPhoneContactsLoadedListener;
import de.moose.messenger.utils.PhoneHelper;
import de.moose.messenger.utils.QuickLoader;
import de.moose.messenger.utils.ReplacingSerialSingleThreadExecutor;
import de.moose.messenger.utils.ReplacingTaskManager;
import de.moose.messenger.utils.Resolver;
import de.moose.messenger.utils.SerialSingleThreadExecutor;
import de.moose.messenger.utils.StringUtils;
import de.moose.messenger.utils.WakeLockHelper;
import de.moose.messenger.xml.Namespace;
import de.moose.messenger.utils.XmppUri;
import de.moose.messenger.xml.Element;
import de.moose.messenger.xmpp.OnBindListener;
import de.moose.messenger.xmpp.OnContactStatusChanged;
import de.moose.messenger.xmpp.OnIqPacketReceived;
import de.moose.messenger.xmpp.OnKeyStatusUpdated;
import de.moose.messenger.xmpp.OnMessageAcknowledged;
import de.moose.messenger.xmpp.OnMessagePacketReceived;
import de.moose.messenger.xmpp.OnPresencePacketReceived;
import de.moose.messenger.xmpp.OnStatusChanged;
import de.moose.messenger.xmpp.OnUpdateBlocklist;
import de.moose.messenger.xmpp.Patches;
import de.moose.messenger.xmpp.XmppConnection;
import de.moose.messenger.xmpp.chatstate.ChatState;
import de.moose.messenger.xmpp.forms.Data;
import de.moose.messenger.xmpp.jingle.JingleConnectionManager;
import de.moose.messenger.xmpp.jingle.OnJinglePacketReceived;
import de.moose.messenger.xmpp.jingle.stanzas.JinglePacket;
import de.moose.messenger.xmpp.mam.MamReference;
import de.moose.messenger.xmpp.pep.Avatar;
import de.moose.messenger.xmpp.pep.PublishOptions;
