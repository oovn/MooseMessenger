...
import de.moose.messenger.databinding.FragmentConversationBinding;
...
import de.moose.messenger.entities.MucOptions.User;
import de.moose.messenger.entities.Presence;
import de.moose.messenger.entities.ReadByMarker;
import de.moose.messenger.entities.Transferable;
import de.moose.messenger.entities.TransferablePlaceholder;
import de.moose.messenger.http.HttpDownloadConnection;
import de.moose.messenger.persistance.FileBackend;
import de.moose.messenger.services.MessageArchiveService;
import de.moose.messenger.services.XmppConnectionService;
import de.moose.messenger.ui.adapter.MediaPreviewAdapter;
import de.moose.messenger.ui.adapter.MessageAdapter;
import de.moose.messenger.ui.util.ActivityResult;
import de.moose.messenger.ui.util.Attachment;
import de.moose.messenger.ui.util.ConversationMenuConfigurator;
import de.moose.messenger.ui.util.DateSeparator;
import de.moose.messenger.ui.util.EditMessageActionModeCallback;
import de.moose.messenger.ui.util.ListViewUtils;
import de.moose.messenger.ui.util.MenuDoubleTabUtil;
import de.moose.messenger.ui.util.MucDetailsContextMenuHelper;
import de.moose.messenger.ui.util.PendingItem;
import de.moose.messenger.ui.util.PresenceSelector;
import de.moose.messenger.ui.util.ScrollState;
import de.moose.messenger.ui.util.SendButtonAction;
import de.moose.messenger.ui.util.SendButtonTool;
import de.moose.messenger.ui.util.ShareUtil;
import de.moose.messenger.ui.widget.EditMessage;
import de.moose.messenger.utils.GeoHelper;
import de.moose.messenger.utils.MessageUtils;
import de.moose.messenger.utils.NickValidityChecker;
import de.moose.messenger.utils.Patterns;
import de.moose.messenger.utils.QuickLoader;
import de.moose.messenger.utils.StylingHelper;
import de.moose.messenger.utils.TimeframeUtils;
import de.moose.messenger.utils.UIHelper;
import de.moose.messenger.xmpp.XmppConnection;
import de.moose.messenger.xmpp.chatstate.ChatState;
import de.moose.messenger.xmpp.jingle.JingleConnection;
import rocks.xmpp.addr.Jid;

import static de.moose.messenger.ui.XmppActivity.EXTRA_ACCOUNT;
import static de.moose.messenger.ui.XmppActivity.REQUEST_INVITE_TO_CONVERSATION;
import static de.moose.messenger.ui.util.SoftKeyboardUtils.hideSoftKeyboard;
