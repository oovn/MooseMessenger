...
import de.moose.messenger.services.ExportLogsService;
...
public class SettingsActivity extends XmppActivity implements
	...
	public void onStart() {
		...
		boolean removeLocation = new Intent("de.moose.messenger.location.request").resolveActivity(getPackageManager()) == null;
