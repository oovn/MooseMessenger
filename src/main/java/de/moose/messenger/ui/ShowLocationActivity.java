...
import de.moose.messenger.databinding.ActivityShowLocationBinding;
import de.moose.messenger.ui.util.LocationHelper;
import de.moose.messenger.ui.util.UriHelper;
import de.moose.messenger.ui.widget.Marker;
import de.moose.messenger.ui.widget.MyLocation;
...
public class ShowLocationActivity extends LocationActivity implements LocationListener {
	...
	protected void onCreate(final Bundle savedInstanceState) {
		...
		if (intent != null) {
			...
			switch (action) {
				case "de.moose.messenger.location.show":
